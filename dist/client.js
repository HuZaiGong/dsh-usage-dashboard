...
function TrendChart({ buckets, t }) {
  ...
  if (tip) {
    ...
    tooltip = React.createElement(
      ...
      React.createElement(
        "div",
        { className: "uds-tooltipRow", style: { marginTop: 4, fontWeight: 600, color: "var(--dsw-alias-label-primary)" } },
