...
function SessionTable({ sessions, t, sort, onSort }) {
  const rows = sorted(sessions, sort).slice(0, 15).map((s) => React.createElement('tr', { key: s.sessionId },
  ...
  return React.createElement('div', { className: 'uds-table' },
    React.createElement('table', null,
      React.createElement('thead', null, React.createElement('tr', null,
        React.createElement(SortTh, { label: t('tableSession'), sortKey: 'lastActivityAt', sort: sort, onSort: onSort }),
...
function ModelTable({ models, t, sort, onSort }) {
  const rows = sorted(models, sort).slice(0, 10).map((m) => React.createElement('tr', { key: m.provider + '/' + m.model },
  ...
  return React.createElement('div', { className: 'uds-table' },
    React.createElement('table', null,
      React.createElement('thead', null, React.createElement('tr', null,
        React.createElement(SortTh, { label: t('tableModel'), sortKey: 'total', sort: sort, onSort: onSort }),
        React.createElement(SortTh, { label: t('calls'), sortKey: 'calls', sort: sort, onSort: onSort }),
        React.createElement(SortTh, { label: t('tableTokens'), sortKey: 'total', sort: sort, onSort: onSort }),
