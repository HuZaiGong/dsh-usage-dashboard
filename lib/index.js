...
// 装配后 Client 侧以 ctx.remote.usageStats.{overview,sessions,models,refresh} 调用。
//
...
import { discoverSessions, diffChanged, readSessionLog } from './scan.js'
import { extractUsage, sumUsage, bucketByDay, groupByModel, filterByRange } from './aggregate.js'
